  ...
  return (
    <div>
      <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 mt-5">
        ...
        <div className="px-4 py-2 bg-white rounded-b-lg border focus:ring-blue-500 focus:border-blue-500 ">
          <textarea 
          onChange={onChange}
            rows={8}
            className="block w-full px-0 text-sm text-gray-800 bg-white  outline-none   "
